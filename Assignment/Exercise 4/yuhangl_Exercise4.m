classdef yuhangl_Exercise4_exported < matlab.apps.AppBase
    ...
    properties (Access = private)
        ...
        % Initial all title names
        titleName1 = 'Peaks data in a Surf plot'
        titleName2 = 'Peaks data in a Mesh plot'
        titleName3 = 'Peaks data in a Contour plot'
        titleName4 = 'Membrane data in a Surf plot'
        titleName5 = 'Membrane data in a Mesh plot'
        titleName6 = 'Membrane data in a Contour plot'
        titleName7 = 'Sinc data in a Surf plot'
        titleName8 = 'Sinc data in a Mesh plot'
        titleName9 = 'Sinc data in a Contour plot'
    end
    
    methods (Access = private)
        function resetBackground(app) % Reset the background of all buttons
            title(app.UIAxes, 'Peaks data in a Mesh plot')
...
%         function resetTitle(app)
%             newTitle=[app.SelectdataDropDown.Value ' data in a ' app.clickButton.Value ' plot']
...
%             app.clickButton = app.MeshButton
%             resetTitle(app)
            resetBackground(app); % Reset the background of all buttons when change data
            ...
            switch value
                case 'Peaks'
                    title(app.UIAxes, app.titleName2)
                case 'Membrane'
                    title(app.UIAxes, app.titleName5)
                case 'Sinc'
                    title(app.UIAxes, app.titleName8)
            end
        end
        ...
        function SurfButtonPushed(app, event)
            ...
            switch value
                case 'Peaks'
                    title(app.UIAxes, app.titleName1)
                case 'Membrane'
                    title(app.UIAxes, app.titleName4)
                case 'Sinc'
                    title(app.UIAxes, app.titleName7)
            end
        end

        % Button pushed function: ContourButton
        function ContourButtonPushed(app, event)
%             app.clickButton=app.ContourButton
%             resetTitle(app)
            resetBackground(app); % Reset the background of all buttons when change data
            ...
            switch value
                case 'Peaks'
                    title(app.UIAxes, app.titleName3)
                case 'Membrane'
                    title(app.UIAxes, app.titleName6)
                case 'Sinc'
                    title(app.UIAxes, app.titleName9)
            end
        end
    end
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = yuhangl_Exercise4_exported
